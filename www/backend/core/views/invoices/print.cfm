            ...
            <tr>
                <td align="right" height="100" valign="top">
                    <cfif len(trim(sysAdminData.logo))>
                        <img alt="Logo" src="#expandPath("userdata/images/logos/#sysAdminData.logo#")#" style="display: block; max-width: 180px; font-size: 16px;" border="0">
                    <cfelse>
                        <img alt="Logo" src="#expandPath("dist/img/logo.png")#" style="display: block; max-width: 180px; font-size: 16px;" border="0">
                    </cfif>
                </td>
            </tr>
            <tr>
